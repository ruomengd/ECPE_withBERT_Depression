...
def run():
    ...
    # Model Code Block
    word_idx_rev, word_id_mapping, word_embedding, pos_embedding = load_w2v_BERT(FLAGS.embedding_dim,
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        for fold in range(1, 11):
            ...
            # 保存模型
            saver.save(sess, 'save/pair/model_P_cause_BERT_pair.ckpt', global_step=fold)  #
            # 保存模型
...
def main(_):
    ...
    for scope_name in ['P_cause_BERT']:
