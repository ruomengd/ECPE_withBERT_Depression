    ...
    with tf.Session(config=tf_config) as sess:
        ...
        for fold in range(1,11):
            ...
            for i in xrange(FLAGS.training_iter):
                ...
                p, r, f1, o_p, o_r, o_f1, keep_rate = prf_2nd_step(te_pair_id_all, te_pair_id, pred_y, fold)
                if f1 > max_f1:
            ...
            # 保存模型
            saver.save(sess, 'save/pair/model_BiLSTM_pair.ckpt', global_step=fold)  #
            # 保存模型
